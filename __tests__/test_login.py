...
class SimpleIOSTests(unittest.TestCase):
    ...
    def setUp(self):
        # set up appium
        app = os.path.abspath('/Users/brett/workspace-app/workspace/ios/build/Build/Products/Debug-iphonesimulator/workspace.app')
    ...
    def _populate(self):
        ...
        self.driver.find
        els = [self.driver.find_element_by_accessibility_id('email'),
               self.driver.find_element_by_accessibility_id('password')]

        # self._sum = 0
        for i in range(2):
            # rnd = randint(0, 10)
            els[0].send_keys("brett@tryworkspace.com")
            els[1].send_keys("backdoor")
            # self._sum += rnd
    ...
    def test_login(self):
        ...
        self.driver.find_element_by_accessibility_id('loginSubmit').click()
